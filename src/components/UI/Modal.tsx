          ...
          >
            <div
              className={clsx(
                ...
                { 'sm:max-w-lg': size === 'sm' },
                'inline-block align-bottom bg-white dark:bg-gray-800 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full rounded-md'
              )}
            >
